# Test disputes state transition function

include("../../src/stf/disputes.jl")

println("=== Disputes STF Test Suite ===\n")

# Test vectors directory
vectors_dir = "jam-test-vectors/stf/disputes/tiny"
...
for test_file in sort(test_vectors)
    ...
    try
        result = run_disputes_test_vector(filepath)
